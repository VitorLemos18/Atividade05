...
const users = require("./controllers/livros");
var mongoose = require('mongoose')
const livro = require('./db/models/livro')
//Mongoose
mongoose.connect('mongodb+srv://czdragon12:hihihi@cluster0.g6nkmln.mongodb.net/livro?retryWrites=true&w=majority').then(()=>{
